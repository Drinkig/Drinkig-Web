...
const steps = [
  {
    number: "01",
    title: "취향을 말해주세요",
    description: "\"달달한 거 좋아해요\", \"쓴 건 싫어요\" 같은 일상 언어로 내 입맛을 표현하면 돼요.",
    icon: (
  ...
  },
  {
    number: "02",
    title: "AI가 와인 언어로 번역",
    description: "소믈리에의 자문을 바탕으로, 당신의 감각을 와인의 맛 체계에 정확히 매핑합니다.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    number: "03",
    title: "딱 맞는 와인 추천",
    description: "내 취향에 맞는 와인을 추천받고, 마셔보면서 취향을 더 선명하게 만들어가요.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-500 text-lg">
            복잡한 와인 공부 없이, 3단계로 나만의 와인을 찾아보세요.
          </p>
        </motion.div>
