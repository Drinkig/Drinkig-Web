                ...
                <div className="space-y-8 text-sm leading-relaxed text-gray-300">
                    ...
                    <section>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><span className="text-white font-medium">자동 수집 항목:</span> 기기정보(모델명, OS 버전, 기기 고유값), 접속 로그, 서비스 이용 기록(검색어, 클릭 이력), 광고 식별자(IDFA/ADID), 광고 상호작용 데이터, 진단 데이터</li>
                            <li><span className="text-white font-medium">선택 항목:</span> 프로필 사진, 성별/연령대 (소셜 로그인 시 동의한 경우에 한함), 테이스팅 노트 내 사진 데이터</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-lg font-semibold mb-3 text-white">제3조 (제3자 서비스 제공업체 및 광고 식별자 수집)</h2>
                        <p>회사는 서비스 내에서 맞춤형 광고를 제공하기 위해 타사의 광고 서비스를 이용하고 있습니다. 이 과정에서 광고 사업자가 이용자의 기기 식별자 및 이용 기록을 자동으로 수집할 수 있습니다.</p>

                        <div className="mt-4">
                            <h3 className="text-white font-medium mb-2">이용하는 제3자 서비스 및 목적</h3>
                            <ul className="space-y-2 pl-2">
                                <li><span className="text-gray-400">서비스명:</span> Google AdMob</li>
                                <li><span className="text-gray-400">제공받는 자:</span> Google LLC</li>
                                <li><span className="text-gray-400">수집 항목:</span> 광고 식별자(IDFA/ADID), 기기 정보, 광고 데이터(노출, 클릭 등), 진단 데이터</li>
                                <li><span className="text-gray-400">이용 목적:</span> 사용자 맞춤형 광고 제공, 광고 성과 분석 및 부정 클릭 방지</li>
                                <li><span className="text-gray-400">개인정보처리방침:</span> <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">https://policies.google.com/privacy</a></li>
                            </ul>
                        </div>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold mb-3 text-white">제4조 (개인정보의 보유 및 이용기간)</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold mb-3 text-white">제5조 (개인정보의 파기절차 및 방법)</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold mb-3 text-white">제6조 (개인정보 보호책임자)</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold mb-3 text-white">제7조 (개인정보의 안전성 확보 조치)</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold mb-3 text-white">제8조 (권익침해 구제방법)</h2>
                    ...
                    <section className="pt-8 border-t border-white/10">
                        ...
                        <p>본 방침은 2026년 1월 21일부터 시행합니다.</p>
                    </section>
                </div>
            </div>
        </div>
